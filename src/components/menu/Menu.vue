    ...
    <ul class="menu">
      ...
      <li>
        ...
        >
            ...
            <font-awesome-icon icon="fa-solid fa-house" style="color: white;" />
            Home
        </a>
      </li>
      ...
      <li>
        <a
        href="#"
        @click.prevent="updateMenu('created')"
        :class="highlightSection('created')"
        >
      ...
      <li>
        <a
        href="#"
        @click.prevent="updateMenu('schedule')"
        :class="highlightSection('schedule')"
        >       
      ...
      <li>
        <a
        href="#"
        @click.prevent="updateMenu('contact')"
        :class="highlightSection('contact')"
        >
        <font-awesome-icon icon="fa-solid fa-users" />
          Account
          <font-awesome-icon icon="fa-solid fa-chevron-right" />
